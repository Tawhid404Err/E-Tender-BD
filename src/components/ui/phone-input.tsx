...
export default function PhoneInput({
    ...
    const [selectedCountry, setSelectedCountry] = useState<Country>(
        countries.find(c => c.code === defaultCountry) || countries.find(c => c.code === "BD")!
    )
    ...
    const handleCountrySelect = (country: Country) => {
        ...
        setManualCode(country.dialCode)
        setIsOpen(false)
        setSearchTerm("")
    }
    ...
    const formatPhoneNumber = (phone: string) => {
        if (!phone) return ""
        // Simple formatting - can be customized based on country
        ...
        <div className={`flex gap-2 ${className}`}>
            ...
            <div className="relative" ref={dropdownRef}>
                <button
                    ...
                    className="h-11 px-3 py-2 rounded-md border border-input bg-background text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 flex items-center gap-2 hover:bg-accent transition-colors w-28"
                >
                    ...
                    <Input
                        ...
                        className="w-16 h-6 px-0 border-0 bg-transparent p-0 text-sm focus-visible:ring-0 focus-visible:ring-offset-0"
                        placeholder="+"
                    />
                ...
                {isOpen && (
                    <div className="absolute top-full left-0 mt-1 w-80 max-h-60 overflow-y-auto bg-white border border-gray-200 rounded-lg shadow-xl z-50">
                        {/* Search Input */}
