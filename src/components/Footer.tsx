        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <Link to="/" className="inline-block mb-4">
              <h3 className="text-2xl font-bold text-[#4874c7]">
                ই-টেন্ডার বিডি
              </h3>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-gray-600">
                <HiMail className="w-5 h-5 text-[#4874c7] flex-shrink-0 mt-0.5" />
                <span>info@etenderbd.com</span>
              </li>
              <li className="flex items-start gap-2 text-sm text-gray-600">
                <HiPhone className="w-5 h-5 text-[#4874c7] flex-shrink-0 mt-0.5" />
                <span>+880 1XXX-XXXXXX</span>
              </li>
              <li className="flex items-start gap-2 text-sm text-gray-600">
                <HiLocationMarker className="w-5 h-5 text-[#4874c7] flex-shrink-0 mt-0.5" />
        ...
        <div className="border-t border-gray-200 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-600">
              © 2024 ই-টেন্ডার বিডি. All rights reserved.
            </p>
